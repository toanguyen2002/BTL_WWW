	...
	<c:when test="${loginFailed == 'false'}">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
				<a class="navbar-brand" href="/WWW_BTL/home">SQA</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<form class="d-flex" action="/WWW_BTL/timkiemsanpham">
					...
					<ul class="navbar-nav">
							<li class="nav-item"><a class="nav-link" href="/WWW_BTL/user/dangNhap">Đăng
									nhập</a></li>
							<li class="nav-item"><a class="nav-link" href="/WWW_BTL/user/dangKy">Đăng
									ký</a></li>
						</ul>
				</div>
			</div>
							...
							<c:choose>
								<c:when test="${userSecurity == 'true'}">
									<ul class="dropdown-menu" aria-labelledby="accountDropdown">
										...
										<li><a class="dropdown-item"
												href="/WWW_BTL/admin/danhSachKhachHang">Quản Lý User</a></li>
											<li><a class="dropdown-item"
								...
								<c:otherwise>
									<ul class="dropdown-menu" aria-labelledby="accountDropdown">
										<li><a class="dropdown-item"
											href="/WWW_BTL/user/thongTinCaNhan">Thông Tin Cá Nhân</a></li>
										<li><a class="dropdown-item"
											href="/WWW_BTL/order/getByUserID?getOrder=${userId}">Lịch Sử Mua Hàng</a></li>
											<li><a class="dropdown-item" href="/WWW_BTL/user/logout">Đăng xuất</a></li>
									</ul>
								</c:otherwise>
							</c:choose></li>
